  ...
  return (
    <div className="container-fluid h-screen grid grid-cols-2 ">
      ...
      <div className="w-full h-full bg-emerald-400 flex justify-center items-center">
        <h1 className="text-3xl px-10 text-white font-bold uppercase">Ingresa tu email y recupera tu  <span className="text-[#364960]">cuenta</span> </h1>
      </div>
        ...
        <div className="bg-[#364960] h-full flex flex-col justify-center items-center py-4 ">
          ...
          <form action="" className="w-3/5" onSubmit={cambiarPassword}>
            ...
            <div className="flex items-center gap-10 mt-16">
              <button className="text-white px-5 py-2 rounded-3xl bg-emerald-400">Cambiar Password</button>
